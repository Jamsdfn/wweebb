...
WHERE {$where}
ORDER BY posts.created desc LIMIT {$offset},{$size};");

//处理分页按钮页码
//==========================
//求最大页码
$total_count = (int)bx_fetch_one("SELECT 
count(1) AS num
FROM posts
INNER JOIN categories ON posts.category_id =categories.id
INNER JOIN users ON posts.user_id = users.id
    ...
    <div class="container-fluid">
        ...
        <div class="page-action">
            ...
            <form class="form-inline" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <select name="status" class="form-control input-sm" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <?php foreach ($posts as $item): ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/admin/post-add.php" class="btn btn-default btn-xs">编辑</a>
